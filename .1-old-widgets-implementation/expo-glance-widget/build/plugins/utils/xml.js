...
class XmlUtils {
    ...
    static mergeStringXml(sourceContent, targetContent, targetPath) {
        try {
            ...
            const mergedStrings = Object.assign(Object.assign({}, targetStrings), sourceStrings);
    ...
    static mergeColorXml(sourceContent, targetContent, targetPath) {
        try {
            ...
            const mergedColors = Object.assign(Object.assign({}, targetColors), sourceColors);
            // Build new XML content
            const xmlHeader = '<?xml version="1.0" encoding="utf-8"?>';
            const resourcesOpen = '<resources>';
            const resourcesClose = '</resources>';
    ...
    static mergeDimensXml(sourceContent, targetContent, targetPath) {
        try {
            ...
            const mergedDimens = Object.assign(Object.assign({}, targetDimens), sourceDimens);
            // Build new XML content
            const xmlHeader = '<?xml version="1.0" encoding="utf-8"?>';
            const resourcesOpen = '<resources>';
            const resourcesClose = '</resources>';
    ...
    static mergeStyleXml(sourceContent, targetContent, targetPath) {
        try {
            ...
            const mergedStyles = Object.assign(Object.assign({}, targetStyles), sourceStyles);
            // Build new XML content
            const xmlHeader = '<?xml version="1.0" encoding="utf-8"?>';
            const resourcesOpen = '<resources>';
            const resourcesClose = '</resources>';
    ...
    static extractStringResources(content) {
        ...
        while ((match = stringRegex.exec(content)) !== null) {
            ...
            strings[name] = Object.assign({ content: value }, (translatable && { translatable }));
        }
        return strings;
    }
    /**
    ...
    static extractStyleResources(content) {
        ...
        while ((match = styleRegex.exec(content)) !== null) {
            ...
            styles[name] = Object.assign(Object.assign({}, (parent && { parent })), { items });
        }
        return styles;
    }
    /**
