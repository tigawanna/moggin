...
function getDefaultedOptions(options) {
    const mergedOptions = Object.assign(Object.assign({}, exports.DEFAULT_OPTIONS), options);
...
const withExpoGlanceWidgets = (config, userOptions = {}) => {
    ...
    const sdkVersion = parseInt(((_a = config.sdkVersion) === null || _a === void 0 ? void 0 : _a.split(".")[0]) || "0", 10);
