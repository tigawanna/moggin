...
import { WithExpoWakatimeGlanceWidgetsProps } from "./withPlugins";

const withComposeProjectLevelDependancyPlugin: ConfigPlugin<WithExpoWakatimeGlanceWidgetsProps> = (config, options) => {
